> English archival transcription, 2026-09-11. Only the scope line was translated.
> The original review is pinned in `../historical-assets-20260911/INDEX.json`.
> This is a historical record, not a new review or current gate decision.
...
**Review scope:** Only the truth-error / projection-boundary evidence increment in PR #34
