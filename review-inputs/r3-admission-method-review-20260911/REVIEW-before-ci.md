...
after failure-retention repairs. This is not a statistical-method review, B-2
...
INPUTS-initial.json fixes the initial candidate. These are file snapshots, not
an asserted immutable commit. No repository files were changed. No real cache
