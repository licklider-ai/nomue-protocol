...
than `2026-10-18T01:51:08Z`. Elapse of that window is necessary but not sufficient:
...
| D01/D07 amendment            | Reviewable input `5996da5a7869f2b21ae8f73407c434285c9862bb`; body-declared opening `2026-09-18T01:50:49Z`, platform `created_at` `2026-09-18T01:51:08Z`; STABLE-INTENT |
...
- The detailed report, not a new or reinterpreted CLI exit code, owns the D07
  pass/proved-mismatch/completed-indeterminate distinction. FD5 must constrain
  the Release 4 supported procedure to terminal completed outcomes or defer the
  indeterminate-only completed-report state to a separately versioned successor;
  code `0` cannot represent that state.
