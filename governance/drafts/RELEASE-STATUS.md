...
| ---------------------------------- | ----------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| R2 paired-t                        | Candidate evidence, review-readiness work and the D5 final selection record are assembled | Close the two D5 open holds - oracle environment record and exact-head numerical review - then prepare the coupled landing | Public review open; unissued                                                  |
...
records two open holds: the reproducible oracle environment record and the exact-head
independent numerical review. Neither is blocked by the discussion window.
