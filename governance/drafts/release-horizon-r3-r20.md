...
| Release 5       | near horizon   | Cross-family declared-design evidence with versioned Profile projection mappings, selection-timing status, successor non-claims, and a common verification-report view                                        | Reuses existing tuple conformance, exact dispatch, Record integrity, and Profile admissibility; all three families require separately accepted Contracts, including an independent-two-group successor, and Release 4 meaning is excluded                              |
