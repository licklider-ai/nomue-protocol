...
| Declared-design Selection Policy and declaration identity              | active                                                                      | Release 5 and later multi-family artifacts                       | Each consumer defines its Design Declaration Envelope, registered policy, exact-one result, and non-claims without standardizing product routing |
