...
| Release 5       | near horizon   | Cross-family declared-design evidence with versioned Profile projection mappings, selection-timing status, successor non-claims, and a common verification-report view                                         | Reuses existing bundle and Profile conformance, exact dispatch, Record integrity, and Profile admissibility; all three families require separately accepted Contracts, including an independent-two-group successor, and Release 4 meaning is excluded                 |
| Releases 6–10   | near horizon   | Rank-based successor Contracts, repeated or clustered dependence, correlation and linear models, categorical outcomes, count or rate outcomes, and survival or time-to-event inference                         | Exact order remains open and is chosen by research maturity, dependency closure, product demand, and ability to form a bounded vertical slice; rank successors still close independently                                                                               |
...
Release 5's earlier rank-based direction moves into the Releases 6–10 candidate
...
| Cross-family declaration projection and timing evidence                | active                                                                      | Release 5 and later multi-family artifacts                       | Each consumer defines versioned per-Profile mappings, the timing owner, scoped non-claims, and the common report view without standardizing product selection |
