...
| Release 5       | near horizon   | Declared-design analysis-selection evidence for a bounded initial set of continuous-outcome Contracts; portable binding of declarations to one exact Contract, Profile, and interpretation bundle              | Reuses exact dispatch, Record integrity, and scoped verification; depends conditionally on accepted Release 2 and Release 3 surfaces and does not import Release 4 factorial meaning                                                                                   |
...
| Declared-design analysis-selection identity                            | active                                                                      | Release 5 and later multi-family artifacts                       | Each consuming release defines its bounded family set, explicit declarations, exact selection policy, and non-claims  |
