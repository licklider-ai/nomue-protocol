...
| Release 5       | near horizon   | A defined projection of Profile-owned declarations and a registered Selection Policy mapping it to one exact Contract, Profile, and interpretation bundle                                                      | Reuses exact dispatch, Record integrity, and scoped verification; all three families require separately accepted Contracts, including an independent-two-group successor, and Release 4 meaning is excluded                                                            |
...
| Declared-design Selection Policy and declaration identity              | active                                                                      | Release 5 and later multi-family artifacts                       | Each consumer defines Profile-owned truth carriers, their common projection, a registered policy, an exact-one result, and non-claims without standardizing product routing |
