...
| Release 4       | next candidate | A bounded factorial and interaction-inference vertical slice                                                                                                                                                   | May reuse applicable Release 3 F-distribution, projection, and multiplicity findings only after acceptance and scope verification; must independently close factorial estimands, design declarations, admissibility, interaction meaning, and any non-reusable numerical graph |
