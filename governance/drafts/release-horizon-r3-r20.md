...
| Declared-design selected-tuple binding and declaration identity        | active                                                                      | Release 5 and later multi-family artifacts                       | Each consumer defines Profile-owned truth carriers, their common projection, one selected-tuple binding, and non-claims without standardizing product selection |
