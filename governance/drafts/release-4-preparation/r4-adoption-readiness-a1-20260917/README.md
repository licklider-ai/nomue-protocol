...
- [Ratification packet](RATIFICATION-PACKET.md): scope, identities and steward decisions.
- [Decision inventory](DECISION-INVENTORY.md): closed selections and their boundaries.
- [Evidence and review map](REVIEW-EVIDENCE-MAP.md): provenance, exact targets and limitations.
- [RFC 261 disposition](RFC-261-DISPOSITION.md): historical holds and downstream impact.
- [R2 benchmark](R2-R4-BENCHMARK.md): actual comparison, not a stronger invented gate.
...
Prepared on 2026-09-17 with OpenAI Codex in the continuing author context, from
public repository material and the maintainer's explicit task-state instruction.
Reported external closure is distinguished from repository review receipts.
No private product material, numerical implementation or formal surface is added.

## Author validation

On 2026-09-17, the author checked all 54 immutable source tuples, 26 referenced
Git objects, packet hashes, local document links and commit-pinned artifact links.
The outgoing changes are restricted to this new directory; existing source,
historical evidence and formal/Public files remain byte-identical to the base.
Repository `pnpm validate`, Markdown lint and packet formatting checks passed.
These are author document-integrity checks, not independent A1 clearance or new
numerical tests. Existing scientific/numerical validation is reused as mapped.
