...
3. If it permits that outcome, does the public CLI receive a new/versioned exit
   contract, or is the CLI outside Release 4's public support surface? The current
   contract requires exactly five codes and has no indeterminate-only bucket.
