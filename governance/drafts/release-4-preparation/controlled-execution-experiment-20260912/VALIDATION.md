...
| ------------------------ | ---------------------------------------------------------------- |
| EXECUTION.json           | 66 checks passed                                                 |
| EXECUTION-OPTIMIZED.json | Same 66 check names passed; optimized parent, fixed normal child |
...
Largest observed benchmark wall interval is about 1.37 seconds on this host.
