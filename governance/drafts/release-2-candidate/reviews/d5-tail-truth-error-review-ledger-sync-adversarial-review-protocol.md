...
`48b2b5802b674c34883f86d9144efdf12e32c9ac`
...
Permitted changes are limited to the exact expected checkpoint review-state strings or comments directly describing that state.
...
Confirm byte-level invariance of authority inputs, registries, authoritative schemas, conformance, issued identifiers, Public Checks, bundles, authoritative verifier dispatch, and Release 1 surfaces.
